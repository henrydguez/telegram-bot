...
const categories={income:['Salario','Trabajo','Ventas','Inversiones','Otros'],expense:['Alimentación','Transporte','Vivienda','Ocio','Compras','Salud','Otros']};
...
function resetActive(){digits[activeType]='';$('activeAmount').value='';$('activeDate').value=today();$('activeCategory').value='';$('activeDescription').value=''}
